...
def matching_label_pairs_perc(matrix1, matrix2, min_perc = 0.5):
    """
    Calculates a list of matching pairs from two images, where there's overlap >= min_perc
    """
...
def binary_to_label(img_cc3_binary, img_phh3_binary):
    """
    Literally just converts your binary images to label images
    """
...
def remove_cells_folder_vs_folder(folder_cc3_binary, folder_phh3_binary, output_folder):
    """
    The big function you should run to correct antibody shift. 

    Args: 
        folder_cc3_binary (str): Fullpath to the folder you want to REMOVE cells from. Use binary image slices folder / output from correct_shift()
        folder_phh3_binary (str): Fullpath to folder you want UNCHANGED
        output_folder (str): Full path for your corrected cc3 image outputs
    """
