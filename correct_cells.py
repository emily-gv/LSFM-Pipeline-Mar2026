...
# using cv2.IMREAD_UNCHANGED to preserve single-channel in label mask thing
def main():
    ...
    list_slices_1 = get_images_from_path('/home/emily/Desktop/CC3_pHH3_comparison/Aug28_2025_27/cc3_slices_binary_shifted')
    list_slices_2 = get_images_from_path('/home/emily/Desktop/CC3_pHH3_comparison/Aug28_2025_27/Step25b_pHH3_slices_binary')
    ...
    for i in range(n_list_slices_1):
        ...
        img_cc3_binary_shifted = cv2.imread(img_slice_path_1, cv2.IMREAD_UNCHANGED)
        img_phh3_binary = cv2.imread(img_slice_path_2, cv2.IMREAD_UNCHANGED)
        ...
        output_folder = '/home/emily/Desktop/CC3_pHH3_comparison/Aug28_2025_27/cc3_corrected'
